...
class Approval3 extends StatefulWidget {
  const Approval3({super.key});

  @override
  State<Approval3> createState() => _Approval3State();
}

class _Approval3State extends State<Approval3> {
  @override
...
class Business3 extends StatefulWidget {
  const Business3({super.key});

  @override
  State<Business3> createState() => _Business3State();
}

class _Business3State extends State<Business3> {
  bool value = false;
  bool value1 = false;
